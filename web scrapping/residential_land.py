# -*- coding: utf-8 -*-
"""residential-land.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1IclV7RVZSVNe3fo5WapspW6uo9uWLTU5
"""
...
csv_file = f"/content/drive/MyDrive/DSMP/Case Studies/Real estate/resedential-Land/resedential_land_gurgaon_data-p{start}-{end}.csv"
pageNumber = start
req = 0
while pageNumber < end:
    ...
    req += 1
    for soup in pageSoup.select_one('div[data-label="SEARCH"]').select(
        ...
        try:
            nearbyLocations = [
                i.text.strip()
                for i in dpageSoup.select_one("div.NearByLocation__tagWrap").select(
        ...
        try:
            features = [
                i.text.strip() for i in dpageSoup.select("#features")[0].select("li")
            ]
        except:
            features = ""
        ...
        try:
            rating = [
                i.text
                for i in dpageSoup.select_one(
                    "div.review__rightSide>div>ul>li>div"
                ).select("div.ratingByFeature__circleWrap")
            ]
        except:
            rating = ""
        # print(top_f)
...
land.to_csv(
    "/content/drive/MyDrive/DSMP/Case Studies/Real estate/resedential-Land/resedential_land_gurgaon_data-p1-100_2122rows.csv",
    index=False,
)
